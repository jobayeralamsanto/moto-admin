...
!(function (e) {
  ...
  function B(n, t) {
    ...
    !0 === (t = void 0 === t ? {} : t) && (t = {}), Array.isArray(t) && (t = { buttons: t }), (this.c = y.extend(!0, {}, B.defaults, t)), t.buttons && (this.c.buttons = t.buttons), (this.s = { dt: new e.Api(n), buttons: [], listenKeys: "", namespace: "dtb" + o++ }), (this.dom = { container: y("<" + this.c.dom.container.tag + "/>").addClass(this.c.dom.container.className) }), this._constructor();
  }
  y.extend(B.prototype, {
      ...
      return (
        ...
        e &&
          ...
          (h = y("<" + p.tag + "/>")
            ...
            .append(l)),
          (b = y.extend(n, { align: f.dropdown.align, attr: { "aria-haspopup": "dialog", "aria-expanded": !1 }, className: f.dropdown.className, closeButton: !1, splitAlignClass: f.dropdown.splitAlignClass, text: f.dropdown.text })),
          this._addKey(b),
          (g = function (t, n, e, o) {
    ...
    (B.defaults = {
      ...
      dom: {
        ...
        split: { action: { className: "dt-button-split-drop-button dt-button", tag: "button" }, dropdown: { align: "split-right", className: "dt-button-split-drop", dropHtml: '<span class="dt-button-down-arrow">&#x25BC;</span>', splitAlignClass: "dt-button-split-left", tag: "button" }, wrapper: { className: "dt-button-split", tag: "div" } },
      },
    }),
    y.extend(_, {
      collection: {
